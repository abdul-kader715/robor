...
Contact Area  
==============================-->
<div class="<?php echo $klass;?>" data-bg-src="assets/img/bg/map-dot-bg3.png" id="contact-sec">
        ...
        <div class="row gy-60">
            <div class="col-xl-6">
                <div class="title-area contact-title-wrap mb-80">
                    <span class="sub-title style4 text-white fadeinup wow" data-wow-duration="1.2s" data-wow-delay="0.1s" data-theme-color="#3282FB">HELP CENTER</span>
            ...
            <div class="col-xl-6">
                <?php get_section('contact-form-v3'); ?>
            </div>
        </div>
    </div>
</div>